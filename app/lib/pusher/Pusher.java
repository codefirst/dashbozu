...
public class Pusher {
     ...
     */
    private static String pusherApplicationId = "";

    /**
     * Pusher Application Key
     */
    private static String pusherApplicationKey = "";

    /**
     * Pusher Secret
     */
    private static String pusherApplicationSecret = "";

    public static void init(String id, String key, String secret) {
        Pusher.pusherApplicationId = id;
        Pusher.pusherApplicationKey = key;
        Pusher.pusherApplicationSecret = secret;
    }
